...
void EnvironmentBenches::update()
{
	...
	car.setCarCollisionRespondEnvBenches(collisionRespond);

	this->entity->setCarObject(car);
}

void EnvironmentBenches::calcBoundingBox(std::vector<std::vector<glm::vec3>> triangles, std::vector<glm::vec3>& boundingBox)
{
...
bool EnvironmentBenches::inBoundingBox(glm::vec3 point, std::vector<glm::vec3> boundingBox)
{
...
bool EnvironmentBenches::collisionCheck(glm::vec3 collisionContourPoint)
{
...
bool EnvironmentBenches::collisionBetweenPoint(glm::vec3 point, float threshold, unsigned int triangle)
{
...
bool EnvironmentBenches::BarycentricCalculation(glm::vec3 point, float dist, unsigned int triangle)
{
